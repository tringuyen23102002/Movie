...
export default function MovieDetail () {
    ...
    const getData = () => {
        fetch (
            `https://api.themoviedb.org/3/movie/${id}?api_key=a635f3ca63e613e8fe5fb9b2790fb1ac&language=en-US`
        )
            .then((res) => res.json())
    ...
    return (
        <div className="movie">
            ...
            <div className="movie_links">
                ...
                {
                    currentMovieDetail && currentMovieDetail.homepage && <a href={currentMovieDetail.homepage} target="_blank" style={{textDecoration:"none"}}></a>
                }
            </div>
                    ...
                    currentMovieDetail && currentMovieDetail.production_companies && currentMovieDetail.production_companies.map(company => (
                        <>
                        {
                            ...
                            <span className="productionCompanyImage">
                                <img className="movie_productionCompany" src={"https://image.tmdb.org/t/o/original" + company.logo_path} />
